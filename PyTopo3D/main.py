...
def main():
    ...
    try:
        ...
        # When an STL design space is provided, voxelization determines the real
        # grid size — propagate it back to args so downstream calls (ndof,
        # boundary conditions, optimization) use the correct dimensions.
